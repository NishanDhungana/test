    ...
    return (
      (t.prototype.init = function () {
        (this._firstItem = []),
          _glMain._webGL &&
            ((this._trgTex = [
              "/manage/wp-content/themes/homunculus/assets/image/texture/main_title.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/main_title_sp.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/burash01.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/paper.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/detailMV_g.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/detailMV_g2.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/mv_mask.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/suna.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/footer_mask.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/footer_mask2.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/statement0_n.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/statement0_b.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/statement1_n.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/statement1_b.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/statement2_n.png",
              "/manage/wp-content/themes/homunculus/assets/image/texture/statement2_b.png",
            ]),
            (this._firstItem = [
              { _type: "texture", _list: this._trgTex },
              {
                _type: "shader",
                _list: [
                  "/manage/wp-content/themes/homunculus/assets/shader/display_vtx.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/display_frg.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/detailMV_vtx.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/detailMV_frg.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/detailMV2_frg.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/detailImg_vtx.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/detailImg_frg.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/detailFooter_vtx.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/detailFooter_frg.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/noise_vtx.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/noise_frg.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/title_vtx.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/title_frg.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/state_vtx.js",
                  "/manage/wp-content/themes/homunculus/assets/shader/state_frg.js",
                ],
              },
            ]));
      }),
    ...
    return (
      (t.prototype.init = function () {
        ...
        (this._address.innerHTML =
          "〒151-0051 東京都渋谷区千駄ヶ谷5-4-9<br class='sp-br'> 第20スカイビル 401<br><a href='https://www.google.co.jp/maps/place/homunculus+Inc./@35.6826944,139.7052635,17z/data=!3m1!4b1!4m5!3m4!1s0x60188cc0dc634acd:0xf0a237df7ce97304!8m2!3d35.6826944!4d139.7074522?hl=ja' target='_blank'>[ Google MAP ]</a>"),
        ...
        (this._modalTxt.innerHTML =
          "<div class='c-comm'>下記のメールアドレスよりお問い合わせください</div><div class='c-info en'><a href='mailto:info@homunculus.jp'>info@homunculus.jp</a></div><span>〒151-0051 東京都渋谷区千駄ヶ谷5-4-9<br class='sp-br'> 第20スカイビル 401<br><a href='https://www.google.co.jp/maps/place/homunculus+Inc./@35.6826944,139.7052635,17z/data=!3m1!4b1!4m5!3m4!1s0x60188cc0dc634acd:0xf0a237df7ce97304!8m2!3d35.6826944!4d139.7074522?hl=ja' target='_blank'>[ Google MAP ]</a></span>"),
    ...
    function t(t, e) {
      ...
      0 == this._id
        ...
        ? (this._dom.classList.add("top-state-2"),
          (e += "企画立案からインタラクションの実装、<br>"),
          (e += "バックエンドの開発まで、<br>"),
          (e += "デジタルコンテンツ制作全般を<br class='sp-br'>"),
          (e += "手掛けています。"))
        : 2 == this._id &&
          (this._dom.classList.add("top-state-3"),
          (e += "より深く、より広く伝達する表現を模索し、<br>"),
          (e += "見た人、触れた人の心に残るような、<br>"),
          (e += "新しいユーザー体験を提供できるよう、<br>"),
          (e += "日々取り組んでいます。")),
    ...
    function t(t) {
      (this._parent = t),
        ...
        (this._copy.innerHTML =
          "It is made by <br>stacking, mixing <br>and melting.");
    }
    return (
      (t.prototype.contentsStart = function () {
      ...
      (t.prototype.contentsStart = function () {
        if (!this.isSet) {
          ...
          e.classList.add("project-list-menu"),
            (e.innerHTML =
              '<span class="menu-h-con">CONTACT</span>/<span class="menu-fb"><a href="https://www.facebook.com/homunculus.jp/" target="_blank">FB</a></span>/<span class="menu-fb"><a href="https://twitter.com/homuculu" target="_blank">TW</a></span>'),
